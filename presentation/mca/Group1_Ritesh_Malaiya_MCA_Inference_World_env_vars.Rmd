...
```{r}
plot(hclust(dist(country_env_df_for_pca[,1]),"ward.D2"))
```

```{r}
h <- hclust(dist(country_env_df_for_pca[,1]),"ward.D2")
...
```{r}
cor(cutree(h, k = 2),country_env_df_for_pca[,1],method = "spearman")
