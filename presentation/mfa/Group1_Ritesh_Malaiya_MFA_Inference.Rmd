...
```{r}
column.design = rep(1, length.out = ncol(country_env_df_for_mfa) )

column.design[ grep('rain',colnames(country_env_df_for_mfa)) ] = 2
column.design[ grep('temp',colnames(country_env_df_for_mfa)) ] = 3
