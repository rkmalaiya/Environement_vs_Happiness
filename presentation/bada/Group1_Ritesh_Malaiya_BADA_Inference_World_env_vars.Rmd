...
country_factor_map_mean <- PTCA4CATA::createFactorMap(country_env_pca$TExPosition.Data$fi,
                                                 col.points = unique(country_env_pca$Plotting.Data$fii.col),
                                                 col.labels = unique(country_env_pca$Plotting.Data$fii.col),
                                                 axis1 = axis1,
                                                 axis2 = axis2,
                                                 display.labels = TRUE,
                                                 cex = 8,alpha.points = 0.8)

#country_label4Map <- PTCA4CATA::createxyLabels.gen(axis1,axis2,lambda = country_env_pca$TExPosition.Data$eigs, tau = country_env_pca$ExPosition.Data$t) 
